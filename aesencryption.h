...
public:
    ...
    static QByteArray Crypt(AESEncryption::Aes level, AESEncryption::Mode mode, const QByteArray &rawText, const QByteArray &key,
                            const QByteArray &iv = NULL, AESEncryption::Padding padding = AESEncryption::ISO);
    static QByteArray Decrypt(AESEncryption::Aes level, AESEncryption::Mode mode, const QByteArray &rawText, const QByteArray &key,
                              const QByteArray &iv = NULL, AESEncryption::Padding padding = AESEncryption::ISO);
    static QByteArray ExpandKey(AESEncryption::Aes level, AESEncryption::Mode mode, const QByteArray &key);
    static QByteArray RemovePadding(const QByteArray &rawText, AESEncryption::Padding padding);
